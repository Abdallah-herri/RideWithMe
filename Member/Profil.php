...
?>
	...
	include '../bd/Connection.php';
			...
			$calculeNote = ("SELECT AVG(note) as note FROM avis WHERE membre_donné =".$_SESSION['id_m']);
			$note = $bd->query($calculeNote);
			$moyen = $note->fetch();

			$calculeAvis = ("SELECT COUNT(*) as avis FROM avis WHERE membre_donné =".$_SESSION['id_m']);
